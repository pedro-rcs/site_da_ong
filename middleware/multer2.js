...
module.exports = (multer({
    ...
    storage: multer.diskStorage({
        ...
        destination: (req, file, cb) => {
            ...
            let pasta_imgs_originais = './public/imgs'

            // Se não tem a pasta, criamos.
            if (!fs.existsSync(pasta_imgs_originais)) fs.mkdirSync(pasta_imgs_originais)

            // Setamos o destino como segundo paramêtro do callback
            cb(null, pasta_imgs_originais)
        },
        ...
        filename: (req, file, cb) => {
           ...
           //  let newPath = Date.now().toString() + '-' + file.originalname.split('.')[0] + '.webp';
